...
namespace OttoMapper.Mapping
{
    internal sealed class ObjectMapExpressionBuilder
    {
        ...
        {
            var srcProp = MappingHelpers.GetPropertyCaseInsensitive(sourceType, destProp.Name, typeMap?.CaseInsensitiveMapping ?? true, typeMap?.IgnoreUnderscoresInPropertyNames ?? true, BindingFlags.Public | BindingFlags.Instance);
